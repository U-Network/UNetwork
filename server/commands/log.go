...
// ---------------------------
// TendermintLogger - wraps the logger in tmlibs

// Interface assertions
var _ tmlog.Logger = (*tendermintLogger)(nil)

type tendermintLogger struct {
	keyvals []interface{}
}

// TendermintLogger returns a new instance of an tendermint logger. With() should
// be called upon the returned instance to set default keys
// #unstable
func TendermintLogger() tmlog.Logger {
	logger := tendermintLogger{keyvals: make([]interface{}, 0)}
	return logger
}

// Debug proxies everything to the go-ethereum logging facilities
// #unstable
func (l tendermintLogger) Debug(msg string, ctx ...interface{}) {
...
// #unstable
func (l tendermintLogger) Info(msg string, ctx ...interface{}) {
	ctx = append(l.keyvals, ctx...)
	log.Info(msg, ctx...)
}
...
// #unstable
func (l tendermintLogger) Error(msg string, ctx ...interface{}) {
	ctx = append(l.keyvals, ctx...)
	log.Error(msg, ctx...)
}
...
// #unstable
func (l tendermintLogger) With(ctx ...interface{}) tmlog.Logger {
